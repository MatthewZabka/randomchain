...
% \]
% as $q \to \infty$, where $i_\ell^\ast = (n_\ell -i_{\ell-1}^\ast)_+$ for $1
% \leq \ell \leq m$. Thus, in order for $\bP[\beta_m = b] \to 1$ as $q\to\infty$,
% we need that $P_{i_m^\ast}^{m}(i_m^\ast-b)\to\infty$ as $q\to\infty$. By
% Lemma~\ref{lem:Pqtoinfty}, we know that $P_{i_m^\ast}^{m}(i_m^\ast-b)\to1$
% as $q\to\infty$ if and only if $i_m^\ast - b =\min(i_m^\ast, n_{m+1})$.  That
% is, 
% 	\begin{align*}
...
\mc{What do you think of the following proof? (I just commented out your proof if you still want it.)}
\begin{proof}[Proof of Theorem~\ref{thm:qtoinfty}]

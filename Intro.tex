...
Chain complexes are algebraic constructions\mc{Can you think of a different way of saying
'algebraic construction'?}used to measure a variety of
...
cohomology, and of course algebraic topology~\cite{hartshorne2013algebraic,brown2012cohomology, hochschild1945cohomology, bott2013differential, hatcher2002algebraic}. 
Specifically, chain
...
\mc{What do you think of the changes I made to the previous paragraph?}
...
random Bockstein operation is given in~\cite[Thm 5.2]{zabka2018random}.
% finds the distribution of a random
% Bockstein operation when the boundary operation of the chain complex is chosen
% randomly. 
\mz{Not sure if the citation format is okay. Also, is what I've
written sufficient for tying it to our paper?}
\mc{I've commented out one sentence on topology, since I don't think we need it in this
paper. I've also re-written the last sentence.}
...
% \mc{Do we have any conventions? What should go here? I don't remember now.} \mz{I don't think we have any. We could get rid of this subsection.}
  ...
  \subsection*{Acknowledgments} The first author would like to thank Peter Bubenik for helpful discussions. \mz{The second author would like to thank the first author for being a badass.} \mc{lmao}
